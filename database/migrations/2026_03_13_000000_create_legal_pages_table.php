    ...
    public function up(): void
    {
        ...
        DB::table('h2u_legal_pages')->insert([
            [
                ...
                'hlp_content' => '<h2>1. Acceptance of Terms</h2><p>By accessing and using UPSI2u, you accept and agree to be bound by the terms and provisions of this agreement.</p><h2>2. User Eligibility & Accounts Registration</h2><p>Restricted to UPSI students and verified community members. Users are responsible for maintaining the confidentiality of their account information and for all activities that occur under their account.</p><h2>3. Student Services & Disclaimers</h2><p>UPSI2u facilitates connections between UPSI students and community members. While we verify student status, we do not guarantee the quality, safety, or legality of services provided. Users engage in transactions at their own risk.</p><h2>4. Safety & Verification</h2><p>For the safety of all users, UPSI2u requires location verification and identity checks (Selfies/Documents). Any attempt to bypass these checks or provide fraudulent data will result in a permanent ban.</p><h2>5. Code of Conduct</h2><p>All users must maintain respectful communication. Harassment, discrimination, or inappropriate behavior is strictly prohibited. Users must report any suspicious activity immediately through the platform.</p><h2>6. Payments & Disputes</h2><p>UPSI2u provides a platform for service requests but is not responsible for payment disputes between parties. Users are encouraged to finalize payments only after the service is successfully completed.</p><h2>7. Account Suspension</h2><p>UPSI2u reserves the right to suspend or terminate accounts that violate community guidelines or safety protocols without prior notice.</p><h2>8. Contact Information</h2><p>For questions about these Terms of Service, please contact us through the platform\'s support system or visit the help desk.</p>',
                'hlp_is_active' => true,
                'created_at' => $now,
                'updated_at' => $now,
            ],
