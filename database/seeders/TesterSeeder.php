    ...
    private function seedService(User $user, array $service): void
    {
        ...
        StudentService::query()->updateOrCreate(
            ...
            [
                ...
                'hss_booking_mode' => 'scheduled',
                'hss_session_duration' => 120,
                'hss_operating_hours' => [
                    'monday' => ['09:00-17:00'],
