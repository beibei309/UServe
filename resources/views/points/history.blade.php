        ...
        <div class="upsi-card p-4 sm:p-5 mb-5 sm:mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center space-x-3 sm:space-x-4">
                    <div class="bg-gradient-to-br from-purple-400 to-blue-500 p-2 sm:p-3 rounded-xl flex-shrink-0">
                        <i class="fas fa-history text-white text-xl sm:text-2xl"></i>
                    </div>
                    <div>
                        <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Points History</h1>
                        <p class="text-sm sm:text-base text-gray-600 mt-1">Complete history of all your points transactions</p>
                    </div>
                </div>
                                ...
                                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                    <div class="flex items-start sm:items-center space-x-3 sm:space-x-4 min-w-0">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="flex flex-wrap items-center gap-x-4 gap-y-1 mt-1 text-sm text-gray-600">
