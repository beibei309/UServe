...
<div class="min-h-screen bg-gray-50 py-5 sm:py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {{-- Your Rank Card --}}
        @if($userRank)
        <div class="bg-purple-500 text-white rounded-2xl p-4 sm:p-5 mb-5 sm:mb-8 shadow-sm">
        ...
        {{-- How to Earn Points --}}
        <div class="mt-5 sm:mt-8 bg-purple-50 border border-purple-200 rounded-2xl p-4 sm:p-5">
        ...
        <div class="mt-5 sm:mt-6 upsi-card p-4 sm:p-5">
