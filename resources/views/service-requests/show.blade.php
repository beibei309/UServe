                            ...
                            <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                                ...
                                <div class="mb-6">
                                    ...
                                    <a href="{{ route('students.profile', $serviceRequest->provider->id) }}"
                                        ...
                                        <img src="{{ $serviceRequest->provider->profile_photo_path ? asset($serviceRequest->provider->profile_photo_path) : 'https://ui-avatars.com/api/?name=' . urlencode($serviceRequest->provider->name) }}"
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('profile.public', $serviceRequest->requester->id) }}"
                                        class="flex items-center gap-3 p-2 -ml-2 rounded-lg hover:bg-gray-50 transition-colors group">
                                        <img src="{{ $serviceRequest->requester->profile_photo_path ? asset($serviceRequest->requester->profile_photo_path) : 'https://ui-avatars.com/api/?name=' . urlencode($serviceRequest->requester->name) }}"
