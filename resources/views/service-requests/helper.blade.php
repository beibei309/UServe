                    ...
                    <div class="p-4 sm:p-5">
                        ...
                        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between mb-5">
                            <div class="flex-1">
                                ...
                                @if($requestCategory)
                      <div class="mt-2 inline-flex items-center gap-1.5 rounded-md px-2 py-1" style="color:{{ $requestCategory->hc_color }}; background-color: {{ $requestCategory->hc_color }}10; border: 1px solid {{ $requestCategory->hc_color }};">
                                        ...
                                        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                            ...
                                            @else
                                                <div class="flex items-center gap-3">
                                                    <span class="text-xs font-semibold text-amber-700">No proof uploaded by buyer</span>
                                                    <button type="button" data-finalize-order="{{ $request->hsr_id }}" data-outcome="paid"
                                                        class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-blue-300 bg-white text-xs font-bold text-blue-700 hover:bg-blue-50 transition-all">
                                                        Mark Paid Manually
                                                    </button>
