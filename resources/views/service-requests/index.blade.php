                                        ...
                                        <div
                                            ...
                                            <div class="p-5 sm:p-6">
                                                ...
                                                <div
                                                    ...
                                                    {{-- LEFT SIDE: Cancel & Report (Icon) & View Details --}}
                                                    <div class="flex items-center gap-2 w-full sm:w-auto">
                                                        ...
                                                        <a href="{{ route('service-requests.show', $request) }}"
                                                            ...
                                                            @if (in_array($request->hsr_status, ['in_progress', 'waiting_payment']) && !($request->hsr_status === 'disputed' || $request->hsr_payment_status === 'dispute'))
                                                                <button data-open-report="{{ $request->hsr_id }}" title="Report Issue"
                                                                    class="inline-flex items-center justify-center gap-2 rounded-lg border border-orange-200 bg-white px-3 py-2 text-xs font-bold text-orange-600 hover:bg-orange-50 transition-colors">
                                                        ...
                                                        @endif
                                                            @if ((int) auth()->id() === (int) $request->hsr_reported_by)
                                                                <form id="cancel-dispute-form-{{ $request->hsr_id }}"
                                                        ...
                                                        @if (($request->hsr_status === 'disputed' || $request->hsr_payment_status === 'dispute') && $request->hsr_dispute_reason)
                                                            <span
