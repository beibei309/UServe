<x-app-layout>
                        ...
                        <div class="relative group">
                            <div class="w-28 h-28 rounded-full overflow-hidden border-4 border-white shadow-lg bg-gray-100">
                                <img id="profile-photo-preview" 
                                      src="{{ $studentsCreateUi['profile_photo_preview_url'] }}" 
                                     alt="Profile Photo" 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <textarea id="bio" name="bio" rows="4" 
                                ...
                                placeholder="Hi, I'm a computer science student passionate about web design...">{{ old('bio', $studentsCreateUi['default_bio']) }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="faculty" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm bg-white">
                                    ...
                                    <option value="Fakulti Komputeran & Meta-Teknologi" {{ old('faculty', $studentsCreateUi['default_faculty']) == 'Fakulti Komputeran & Meta-Teknologi' ? 'selected' : '' }}>Fakulti Komputeran & Meta-Teknologi</option>
                                    <option value="Fakulti Pengurusan & Ekonomi" {{ old('faculty', $studentsCreateUi['default_faculty']) == 'Fakulti Pengurusan & Ekonomi' ? 'selected' : '' }}>Fakulti Pengurusan & Ekonomi</option>
                                    <option value="Fakulti Seni, Kelestarian & Industri Kreatif" {{ old('faculty', $studentsCreateUi['default_faculty']) == 'Fakulti Seni, Kelestarian & Industri Kreatif' ? 'selected' : '' }}>Fakulti Seni, Kelestarian & Industri Kreatif</option>
                                    <option value="Fakulti Sains Kemanusiaan" {{ old('faculty', $studentsCreateUi['default_faculty']) == 'Fakulti Sains Kemanusiaan' ? 'selected' : '' }}>Fakulti Sains Kemanusiaan</option>
                                    <option value="Fakulti Sains & Matematik" {{ old('faculty', $studentsCreateUi['default_faculty']) == 'Fakulti Sains & Matematik' ? 'selected' : '' }}>Fakulti Sains & Matematik</option>
                                    <option value="Fakulti Bahasa & Komunikasi" {{ old('faculty', $studentsCreateUi['default_faculty']) == 'Fakulti Bahasa & Komunikasi' ? 'selected' : '' }}>Fakulti Bahasa & Komunikasi</option>
                                    <option value="Fakulti Pembangunan Manusia" {{ old('faculty', $studentsCreateUi['default_faculty']) == 'Fakulti Pembangunan Manusia' ? 'selected' : '' }}>Fakulti Pembangunan Manusia</option>
                                    <option value="Fakulti Muzik & Seni Persembahan" {{ old('faculty', $studentsCreateUi['default_faculty']) == 'Fakulti Muzik & Seni Persembahan' ? 'selected' : '' }}>Fakulti Muzik & Seni Persembahan</option>
                                    <option value="Fakulti Sains Sukan & Kejurulatihan" {{ old('faculty', $studentsCreateUi['default_faculty']) == 'Fakulti Sains Sukan & Kejurulatihan' ? 'selected' : '' }}>Fakulti Sains Sukan & Kejurulatihan</option>
                                    <option value="Fakulti Teknikal & Vokasional" {{ old('faculty', $studentsCreateUi['default_faculty']) == 'Fakulti Teknikal & Vokasional' ? 'selected' : '' }}>Fakulti Teknikal & Vokasional</option>
                                </select>
                                @error('faculty')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="text" name="course" 
                                    ...
                                    value="{{ old('course', $studentsCreateUi['default_course']) }}" />
                                @error('course')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <input type="text" name="skills" 
                                ...
                                value="{{ old('skills', $studentsCreateUi['default_skills']) }}" />
                            @error('skills')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                <textarea id="work_experience_message" name="work_experience_message" rows="3" 
                                    ...
                                    placeholder="Briefly describe your past work experience...">{{ old('work_experience_message', $studentsCreateUi['default_work_experience_message']) }}</textarea>
    ...
    <div id="studentsCreateConfig"
        data-ready-to-help="{{ session('ready_to_help') ? 'true' : 'false' }}"
        data-services-create-url="{{ route('services.create') }}"></div>
    @push('scripts')
