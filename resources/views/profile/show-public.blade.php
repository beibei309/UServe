                    ...
                    <div class="absolute -top-16 left-8">
                        @if ($user->hu_profile_photo_path)
                            <img src="{{ asset($user->hu_profile_photo_path) }}"
                                onerror="if (this.dataset.fallbackApplied === '1') return; this.dataset.fallbackApplied = '1'; this.src='{{ upsi2u_avatar_url($user->hu_name) }}';"
                                    ...
                                    <div class="flex-shrink-0">
                                        ...
                                        @if ($review->reviewer && $review->reviewer->hu_profile_photo_path)
                                            <img src="{{ asset($review->reviewer->hu_profile_photo_path) }}"
                                                onerror="if (this.dataset.fallbackApplied === '1') return; this.dataset.fallbackApplied = '1'; this.src='{{ upsi2u_avatar_url($review->reviewer->hu_name ?? 'Anonymous') }}';"
