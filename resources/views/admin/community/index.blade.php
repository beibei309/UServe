...
@section('content')
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="flex-shrink-0">
                                                                    <img class="h-10 w-10 rounded-full object-cover"
                                                                        ...
                                                                        onerror="this.onerror=null;this.src='{{ upsi2u_avatar_url($review->reviewer->hu_name ?? 'User') }}';"
                                                                        alt="">
                                                                </div>
    ...
    <div id="blacklistModal"
        class="modal-overlay hidden fixed inset-0 bg-black bg-opacity-75 backdrop-blur-sm
