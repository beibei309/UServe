                        ...
                        <ul id="pageMenu"
                            ...
                            <li>
                                <a href="{{ route('admin.legal-pages.index') }}"
                                    class="block px-4 py-2 text-sm rounded-lg transition-colors duration-300 submenu-hover {{ request()->routeIs('admin.legal-pages.*') ? 'text-cyan-400 font-semibold' : '' }}"
                                    style="color: var(--text-secondary);">Terms & Privacy</a>
                            </li>
                        </ul>
                    </li>
                    <li>
            ...
            {{ request()->routeIs('admin.services.*') || request()->routeIs('admin.services.*') ? 'text-white font-semibold' : '' }}"
                    ...
                    <li>
                        <a href="{{ route('admin.reports.page') }}"
                            class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors duration-300 nav-hover
                           {{ request()->routeIs('admin.reports.*') ? 'bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold' : '' }}"
